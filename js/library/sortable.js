(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["Sortable"] = factory();
  else root["Sortable"] = factory();
})(window, function() {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        const defaultAnnouncements = {
          "drag:start": event =>
            `Picked up ${event.source.textContent.trim() ||
              event.source.id ||
              "draggable element"}`,
          "drag:stop": event =>
            `Released ${event.source.textContent.trim() ||
              event.source.id ||
              "draggable element"}`
        };
        ...
        class Draggable {
          ...
          constructor(containers = [document.body], options = {}) {
            ...
            const defaultPlugins = Object.values(Draggable.Plugins).map(
              Plugin => Plugin
            );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        class ForceTouchSensor extends _Sensor2.default {
          ...
          constructor(containers = [], options = {}) {
            ...
            this[onMouseForceWillBegin] = this[onMouseForceWillBegin].bind(
              this
            );
        ...
        class TouchSensor extends _Sensor2.default {
          ...
          [onTouchStart](event) {
            ...
            this.tapTimeout = setTimeout(
              this[onTouchHold](event, container),
              this.options.delay
            );
          }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        class MouseSensor extends _Sensor2.default {
          ...
          constructor(containers = [], options = {}) {
            ...
            this[onContextMenuWhileDragging] = this[
              onContextMenuWhileDragging
            ].bind(this);
            this[onMouseDown] = this[onMouseDown].bind(this);
            this[onMouseMove] = this[onMouseMove].bind(this);
            this[onMouseUp] = this[onMouseUp].bind(this);
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function isStaticallyPositioned(element) {
          const position = getComputedStyle(element).getPropertyValue(
            "position"
          );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        const onDragMove = (exports.onDragMove = Symbol("onDragMove"));
        const onDragStop = (exports.onDragStop = Symbol("onDragStop"));
        const onMirrorCreated = (exports.onMirrorCreated = Symbol(
          "onMirrorCreated"
        ));
        ...
        function calculateMirrorOffset(_ref3) {
          let { sensorEvent, sourceRect, options } = _ref3,
            args = _objectWithoutProperties(_ref3, [
              "sensorEvent",
              "sourceRect",
              "options"
            ]);
        ...
        function positionMirror({ withFrame = false, initial = false } = {}) {
          return _ref7 => {
            let {
              ...
              args = _objectWithoutProperties(_ref7, [
                "mirror",
                "sensorEvent",
                "mirrorOffset",
                "initialY",
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function stripElement(element) {
          const tabIndexElementPosition = elementsWithMissingTabIndex.indexOf(
            element
          );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        class Sortable extends _Draggable2.default {
           ...
           */
          index(element) {
            return this.getDraggableElementsForContainer(
              element.parentNode
            ).indexOf(element);
          }
          ...
          [onDragOverContainer](event) {
            ...
            const children = this.getDraggableElementsForContainer(
              overContainer
            );
